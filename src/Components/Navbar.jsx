      ...
      <nav className="nav container">
        ...
        <div className={`nav__menu ${showMenu ? 'show-menu' : ''}`} id="nav-menu">
          <ul className='nav__list'>
            ...
            <li className="nav__item">
              <a href="#acerca" className="nav__link">Nosotros</a>
            </li>
            <li className="nav__item">
              <a href="#portafolio" className="nav__link">Portafolio</a>
            </li>
            <li className="nav__item">
              <a href="#portafolio" className="nav__link">Proyectos </a>
            </li>
            <li className="nav__item">
              <a href="https://wa.link/hwe3g1" target='_blank'  rel="noopener noreferrer" className="button">Contáctanos</a>
            </li>
          </ul>

                <button className='nav__button'>Cotiza ahora</button>
